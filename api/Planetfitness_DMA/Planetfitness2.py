...
path1 = "C:\\Users\\deepanshu.balani\\OneDrive - Nabler Web Solutions Pvt. Ltd\\Documents\\BrandIndex Crossmedia\\BrandIndex_Planetfitness2\\"
...
def process_df(filename):
    ...
    path1 = "C:\\Users\\deepanshu.balani\\OneDrive - Nabler Web Solutions Pvt. Ltd\\Documents\\BrandIndex Crossmedia\\BrandIndex_Planetfitness2\\"
    with open(path1 + filename + ".json", "r") as f:
        content = f.read()
    ...
    for queries in chunks(total_queries, max_queries_single_go):
        ...
        output_status_message(
            "Successfully ran brand index analysis for the brand and file : {} {}".format(
                brand, filename
            )
        )
...
df_cluster1 = process_df("Planetfitness2_cluster1")
df_cluster2 = process_df("Planetfitness2_cluster2")
df_cluster3 = process_df("Planetfitness2_cluster3")
df_cluster4 = process_df("Planetfitness2_cluster4")
df_cluster5 = process_df("Planetfitness2_cluster5")
df_cluster6 = process_df("Planetfitness2_cluster6")

df = pd.concat(
    [df_cluster1, df_cluster2, df_cluster3, df_cluster4, df_cluster5, df_cluster6]
)
