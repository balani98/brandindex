...
filters = [
    ...
    {"segment": "Total Population", "filters": []},
    {
        ...
        "filters": [
            {
                "expression": "profiles_us__pdl_inputstate in [4, 5, 6, 8, 16, 17, 18, 19, 20, 21, 27, 29, 30, 31, 32, 35, 37, 38, 39, 41, 46, 47, 49, 53, 55, 56]"
            },
        ],
    },
    {
        "segment": "Seattle",
        "filters": [
            {"expression": "top60dmas2_inputzip in [13]"},
        ],
    },
    {
        "segment": "Charlotte",
        "filters": [
            {"expression": "top60dmas2_inputzip in [25]"},
        ],
    },
    {
        "segment": "Portland, OR",
        "filters": [
            {"expression": "top60dmas2_inputzip in [22]"},
        ],
    },
    {
        "segment": "Sacramento",
        "filters": [
            {"expression": "top60dmas2_inputzip in [20]"},
        ],
    },
    {
        "segment": "Los Angeles",
        "filters": [
            {"expression": "top60dmas2_inputzip in [2]"},
        ],
    },
    {
        "segment": "San Francisco",
        "filters": [
            {"expression": "top60dmas2_inputzip in [6]"},
        ],
    },
    {
        "segment": "San Diego",
        "filters": [
            {"expression": "top60dmas2_inputzip in [28]"},
        ],
    },
    {
        "segment": "Minneapolis",
        "filters": [
            {"expression": "top60dmas2_inputzip in [15]"},
        ],
    },
    {
        "segment": "Union Bank",
        "filters": [
            {
                "expression": "profiles_us__pdlc_inputzipdma_recode in [803, 807, 819, 820, 825, 862]"
            },
        ],
    },
    {
        ...
        "filters": [
            {
                "expression": "profiles_us__pdlc_inputzipdma_recode in [803, 807, 825, 862]"
            },
        ],
    },
    {
        ...
        "filters": [
            {"expression": "profiles_us__pdlc_inputzipdma_recode in [803, 825]"},
        ],
    },
    {
        "segment": "In market - Deposits",
        "filters": [
            {"expression": "bank_account_future in [1,2,4]"},
        ],
    },
]
...
with open(
    "C:\\Users\\deepanshu.balani\\OneDrive - Nabler Web Solutions Pvt. Ltd\\Documents\\BrandIndex Crossmedia\\BrandIndex_USBHealthAPI\\USBHealth.json",
    "w",
) as f:
